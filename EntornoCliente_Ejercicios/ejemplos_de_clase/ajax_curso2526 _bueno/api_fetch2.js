...
const getAll = async () => {
    ...
    la API de fetch */
        let respuesta = await fetch("http://localhost:3000/api/usuarios"),
...
para que  lo importe con el contenido porque si fuera false lo crearía vacío,
        ...
        //implemntamos el try-catch de la función asíncrona para manejar éxito-error
            try {
                ...
                let options = {
                    ...
                    respuesta = await fetch("http://localhost:3000/api/usuarios", options),
                    json = await respuesta.json();
            ...
            try {
                let options = {
                    ...
                    let respuesta = await fetch(`http://localhost:3000/api/usuarios/${e.target.id.value}`,
                                            options);
            ...
            try {
                let options = {
                    ...
                    respuesta = await fetch(
                        `http://localhost:3000/api/usuarios/${e.target.dataset.id}`,
                        options
                    ),
                    json = await respuesta.json();
